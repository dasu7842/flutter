...
class CategoryPage extends State<Category> {
  ...
  Future<List> viewCategoryItemsData() async{
    final responce = await http.get(Uri.parse("https://darshan7842.000webhostapp.com/project1/category_image_view.php?data=${widget.index}"));
      ...
      child: GridView.count(
        ...
        children: List.generate(list.length, (index) {
          return Card(
              ...
              child: Column(
                children: [
                  Image.network(list[index]['c_image'],
