...
class UserDashboardScreen2 extends State<UserDashboardScreen> {
  ...
  {
    final responce = await http.get(Uri.parse("https://darshan7842.000webhostapp.com/project1/category_view.php"));
  ...
  Widget build(BuildContext context)
  {
    ...
    return Scaffold
      (
      appBar: AppBar(backgroundColor: Colors.grey,title:Text("Welcome",style: TextStyle(fontWeight: FontWeight.bold),),actions:
      [
            ...
            child: GridView.count(
              ...
              children: List.generate(list.length, (index) {
                return InkWell(
                  onTap: ()
                  {
                    Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (BuildContext context)=>Category(index: list[index]['id'],category_name: list[index]['category_name'])));
                  },
                  child: Card(
                    elevation: 3,
